...
export default function Home() {
    ...
    useEffect(() => {
        ...
        }, 10000); // Simulated loading time for the gallery
            ...
            <div>
                <section id="gallery-section" className="h-screen mt-28">
                    ...
                    <div className="w-screen flex justify-center no-scrollbar cursor-pointer">
                        <div className="w-[90vw] mb-24 lg:w-[59vw] h-[50vh] md:h-[75vh] lg:h-[90vh] flex justify-center no-scrollbar flex-row md:flex-col">
                            {galleryLoading ? (
