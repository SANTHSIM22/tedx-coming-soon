...
export const ScrollVelocity = memo(({ children, velocity = 5, movable = true, clamp = false }: Props) => {
  ...
  // Reduced the range for velocityFactor to lessen performance load
  ...
  // UseAnimationFrame with throttling logic to improve performance
    ...
    <div className="relative m-0 flex flex-nowrap overflow-hidden whitespace-nowrap leading-[0.8] tracking-[-2px]">
      ...
      >
        {typeof children === "string" ? (
          <>
            {/* Reduced number of repeats to enhance performance */}
